...
void MX_TIM5_Init(void)
{
  ...
  HAL_TIM_Base_Start_IT(&htim5);                          /* �??启周期中�?? */
  HAL_TIMEx_HallSensor_Start_IT(&htim5);                  /* �??启霍尔中�?? */
...
{
    __HAL_TIM_SET_COMPARE(&htim1, TIM_CHANNEL_1, PwmValue[0]);
    __HAL_TIM_SET_COMPARE(&htim1, TIM_CHANNEL_2, PwmValue[1]);
    __HAL_TIM_SET_COMPARE(&htim1, TIM_CHANNEL_3, PwmValue[2]);
}
/* USER CODE END 1 */
