...
/* XCP page switching */
    ...
    !defined ( XCP_DISABLE_CALIBRATION_PAGE )
...
/* XCP protocol data acquisition parameters (DAQ) */
    ...
    #define XCP_DISABLE_SEND_QUEUE
        ...
        !defined(XCP_DISABLE_DAQ_HDR_ODT_DAQ)
        ...
        !defined(XCP_DISABLE_DAQ_PROCESSOR_INFO)
        #define XCP_ENABLE_DAQ_PROCESSOR_INFO
    #endif
    #if !defined(XCP_ENABLE_DAQ_RESOLUTION_INFO) &&\
        !defined(XCP_DISABLE_DAQ_RESOLUTION_INFO)
        ...
        !defined(XCP_DISABLE_DAQ_OVERRUN_INDICATION)
        ...
        !defined(XCP_DISABLE_DAQ_EVENT_INFO)
