...
Boolean dis_normal_xmit; // 禁止发送标志
Boolean dis_normal_recv; // 禁止接收标志

/******************************************************************************
 * 函数名称: Boolean service_28_check_len(const uint8_t* msg_buf, uint16_t msg_dlc)
 ...
 * 其它说明: 无
 ******************************************************************************/
Boolean service_28_check_len(const uint8_t *msg_buf, uint16_t msg_dlc)
{
    Boolean ret = FALSE;
