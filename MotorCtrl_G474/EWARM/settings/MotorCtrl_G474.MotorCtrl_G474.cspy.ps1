...
{
& "E:\Program Files\IAR Systems\Embedded Workbench 9.1\common\bin\cspybat" -f "D:\All_Project\IAR_Project\FOC\MotorCtrl_G474\EWARM\settings\MotorCtrl_G474.MotorCtrl_G474.general.xcl" --debug_file=$debugfile --backend -f "D:\All_Project\IAR_Project\FOC\MotorCtrl_G474\EWARM\settings\MotorCtrl_G474.MotorCtrl_G474.driver.xcl" 
}
